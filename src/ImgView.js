...
<img src={this.state.propsimg} className="modalimg"></img>
    ...
    <button className="btn modalcartbtn px-lg-5 px-md-5 px-sm-5 px-3 mt-4 pt-2 pb-2" onClick={this.addtocart}>View Cart</button>
        <button className="btn modalcheckoutbutton  px-lg-5 px-md-5 px-sm-5 px-2  mt-4 pt-2 pb-2" onClick={this.addtocart}>Proceed to checkout</button>
                               </div>
      </div>
         </div>
            ...
            <div className="row pt-3 pb-3 bg-light">
                ...
                <div className="col-lg-7 col-md-6 pt-lg-2 pt-md-2 pt-sm-4 pt-4 px-lg-5 px-md-5 px-sm-4 px-4">
                  ...
                  {this.state.propssale=="no sale"?(<p className="propprice">PKR {this.state.propsprice}</p>):(<div><p className="propprice" style={{textDecorationLine:"line-through"}}>PKR {this.state.propsprice}</p><p className="propssale" >PKR {this.state.propssale}</p></div>)}
